...
**Figure 1. Overall architecture of the GEN pipeline.**
...
**Figure 2. Structure of the ACMG-inspired evidence engine, from individual evidence functions to final classification.**
*[Insert ACMG evidence engine diagram here]*
...
**Figure 3. Workflow diagram rendered inside the generated PDF report.**
...
**Figure 4. Example results page generated by GEN for a submitted variant.**
*[Insert results page screenshot here]*

**Figure 5. Example PDF report generated by GEN for the same variant.**
*[Insert PDF report screenshot here]*
...
**Table I. Demonstration examples of GEN's evidence-scoring output (worked from the documented scoring rules, not a live-captured benchmark).**
